...
const REASON_BY_DECISION = Object.freeze({
    ...
    "BT-DM-0001": { reason: "BT-RN-0004", name: "Unauthorized Hard Inquiry" },
    ...
    "BT-DM-0009": { reason: "BT-RN-0007", name: "Third-Party Collection" },
    "BT-DM-0010": { reason: "BT-RN-0007", name: "Third-Party Collection" },
    "BT-DM-0011": { reason: "BT-RN-0010", name: "Incorrect Balance" },
    "BT-DM-0012": { reason: "BT-RN-0010", name: "Incorrect Balance" },
    "BT-DM-0013": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0014": { reason: "BT-RN-0012", name: "Incorrect Payment History" },
    "BT-DM-0015": { reason: "BT-RN-0012", name: "Incorrect Payment History" },
    "BT-DM-0016": { reason: "BT-RN-0012", name: "Incorrect Payment History" },
    "BT-DM-0017": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0018": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0019": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0020": { reason: "BT-RN-0020", name: "Failure to Update" },
    "BT-DM-0021": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0022": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0023": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0024": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0025": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0026": { reason: "BT-RN-0017", name: "Identity Theft" },
    "BT-DM-0027": { reason: "BT-RN-0017", name: "Identity Theft" },
    "BT-DM-0028": { reason: "BT-RN-0001", name: "Incorrect Name" },
    "BT-DM-0029": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0030": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0031": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0032": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0033": { reason: "BT-RN-0018", name: "Metro 2 Inconsistency" },
    "BT-DM-0034": { reason: "BT-RN-0010", name: "Incorrect Balance" },
    "BT-DM-0035": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0036": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0037": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0038": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0039": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0040": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0041": { reason: "BT-RN-0023", name: "Notice & Cure" },
    "BT-DM-0042": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0043": { reason: "BT-RN-0019", name: "Failure to Investigate" },
    "BT-DM-0044": { reason: "BT-RN-0019", name: "Failure to Investigate" },
    "BT-DM-0045": { reason: "BT-RN-0024", name: "S-2(b) Violation" },
    "BT-DM-0046": { reason: "BT-RN-0025", name: "Arbitration Eligible" },
    "BT-DM-0047": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0048": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0049": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0050": { reason: "BT-RN-0026", name: "No Action Recommended" },
    "BT-DM-0051": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0052": { reason: "BT-RN-0004", name: "Unauthorized Hard Inquiry" },
    "BT-DM-0053": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0054": { reason: "BT-RN-0022", name: "Cannot Verify" },
    "BT-DM-0055": { reason: "BT-RN-0004", name: "Unauthorized Hard Inquiry" },
});
...
const INSTRUCTION_BY_REASON = Object.freeze({
    ...
    "BT-RN-0017": { instruction: "BT-IN-0014", name: "Identity Theft Package" },
    ...
    "BT-RN-0024": { instruction: "BT-IN-0021", name: "S-2(b) Escalation" },
    "BT-RN-0025": { instruction: "BT-IN-0022", name: "Arbitration Preparation" },
...
const BLUEPRINT_BY_INSTRUCTION = Object.freeze({
    ...
    "BT-IN-0011": { blueprint: "BT-BP-0011", name: "Failure to Conduct Reasonable Investigation" },
    "BT-IN-0013": { blueprint: "BT-BP-0013", name: "Notice & Cure" },
    "BT-IN-0014": { blueprint: "BT-BP-0014", name: "S-2(b) Escalation" },
    "BT-IN-0015": { blueprint: "BT-BP-0015", name: "Arbitration Preparation" },
    ...
    "BT-IN-0021": { blueprint: "BT-BP-0014", name: "S-2(b) Escalation" },
    "BT-IN-0022": { blueprint: "BT-BP-0015", name: "Arbitration Preparation" },
